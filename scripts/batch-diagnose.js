...
const PACKAGES = {
  npm: [
    ...
    'playwright', 'selenium-webdriver', 'cypress', 'webdriverio', 'testcafe', 'nightwatch', 'codeceptjs',
    ...
    'redis', 'ioredis', 'mongodb', 'mongoose', 'mysql2', 'pg', '@libsql/client', 'drizzle-orm',
    'bull', 'bullmq', 'bee-queue', 'agenda', 'node-cron', 'node-schedule', 'bree', 'toad-scheduler',
    'nodemailer', 'sendgrid', '@sendgrid/mail', 'mailgun-js', 'postmark', 'resend', 'sharp', 'jimp', 'canvas', 'puppeteer-core', 'playwright-core', 'ffmpeg-static', 'fluent-ffmpeg',
    'socket.io', 'ws', 'sockjs', 'faye-websocket', 'uws', 'websocket', 'ws-wrapper',
    'passport', '@auth/core', 'next-auth', 'lucia', 'auth0', 'clerk', 'firebase-auth', 'zod', 'yup', 'joi', 'ajv', 'class-validator', 'io-ts', 'runtypes', 'superstruct', 'valibot',
    ...
    'cheerio', 'jsdom', 'playwright', 'linkedom', 'happy-dom', 'parse5', 'htmlparser2',
    'marked', 'markdown-it', 'remark', 'rehype', 'mdx', 'unified', 'hast', 'xast', 'bcrypt', 'argon2', 'scrypt', 'pbkdf2', 'crypto-js', 'tweetnacl', 'libsodium-wrappers',
    ...
    'pdfkit', 'puppeteer-pdf', 'wkhtmltopdf', 'weasyprint', 'gotenberg-js-client',
    ...
    'natural', 'compromise', 'retext', 'franc', 'cld', 'tinyld', 'langdetect',
    ...
    'mocha', 'jest', 'jasmine', 'karma', 'ava', 'tap', 'tape', 'vitest', 'playwright-test',
    ...
    'twilio', '@sendgrid/mail', 'mailgun-js', 'postmark', 'resend', 'nodemailer',
    ...
    'mysql2', 'pg', 'postgres', 'better-sqlite3', '@libsql/client', 'drizzle-orm',
    ...
    'multer', 'formidable', 'busboy', 'express-fileupload', 'file-type', 'mime', 'csv-parser', 'fast-csv', 'papaparse', 'xlsx', 'exceljs', 'sheetjs', 'csv-write-stream',
    'pdfkit', 'puppeteer-pdf', 'wkhtmltopdf', 'weasyprint', 'pagedjs',
    ...
    'natural', 'compromise', 'retext', 'franc', 'cld', 'tinyld', 'langdetect', 'fasttext',
  ...
  pypi: [
    ...
    'sqlalchemy', 'django-orm', 'peewee', 'tortoise-orm', 'ormar', 'psycopg2', 'psycopg', 'pymongo', 'redis', 'pymysql', 'asyncpg', 'aioredis',
    ...
    'jsonschema', 'orjson', 'ujson', 'msgspec', 'cbor2',
    ...
    'boto3', 'botocore', 'azure-storage', 'google-cloud-storage', 'firebase-admin', 'celery', 'rq', 'dramatiq', 'huey', 'procrastinate', 'celery-redbeat', 'flower',
    'scrapy', 'beautifulsoup4', 'lxml', 'html5lib', 'pyquery', 'mechanize', 'requests-html',
    'selenium', 'playwright', 'splinter', 'robobrowser',
    'paramiko', 'fabric', 'ansible', 'salt', 'puppet', 'chef', 'docker', 'docker-compose', 'podman', 'kubernetes', 'helm', 'skaffold', 'tilt',
    ...
    'numpy', 'scipy', 'xarray', 'netcdf4', 'h5py', 'zarr', 'cupy',
    ...
    'spacy', 'nltk', 'gensim', 'textblob', 'polyglot', 'stanza', 'allennlp',
    ...
    'astropy', 'sunpy', 'spacepy', 'poliastro', 'skyfield', 'jplephem',
    'biopython', 'scikit-bio', 'pysam', 'pydna', 'tellurium', 'libroadrunner',
    ...
    'zmq', 'pyzmq', 'pika', 'kafka-python', 'confluent-kafka', 'aiokafka', 'websockets', 'socketio', 'aiohttp-sse', 'flask-sse', 'django-sse', 'grpcio', 'protobuf', 'thrift', 'avro', 'msgpack', 'capnproto', 'flatbuffers',
    'pydantic', 'dataclasses-json', 'marshmallow', 'cattrs', 'apischema', 'pyserde',
    'sqlalchemy', 'alembic', 'peewee-migrate', 'yoyo-migrations',
    'pytest', 'unittest', 'nose', 'hypothesis', 'tox', 'nox', 'coverage', 'pytest-cov',
    'mypy', 'pyright', 'pylint', 'flake8', 'black', 'isort', 'ruff', 'bandit', 'safety',
    'sphinx', 'mkdocs', 'pdoc', 'pydoc-markdown', 'readme-renderer', 'twine', 'wheel',
    'setuptools', 'poetry', 'pipenv', 'hatch', 'pdm', 'flit', 'build', 'installer',
    'pip', 'pip-tools', 'pipx', 'pipenv', 'conda', 'mamba', 'pixi',
  ],
  crates: [
    ...
    'rusqlite', 'libsqlite3-sys', 'sqlite', 'sql-builder', 'sqlite-vfs',
  ...
  rubygems: [
    ...
    'pg', 'mysql2', 'mongo', 'redis', 'cassandra-driver', 'neo4j-core',
  ...
  packagist: [
    ...
    'symfony/security', 'symfony/validator', 'symfony/form',
    'symfony/serializer', 'symfony/property-access', 'symfony/property-info', 'symfony/cache',
    'symfony/translation', 'symfony/intl', 'symfony/locale', 'symfony/asset', 'symfony/templating', 'symfony/twig-bridge', 'symfony/twig-bundle',
